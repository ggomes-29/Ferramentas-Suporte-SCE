...
echo off
TITLE FERRAMENTAS SUPORTE SCE --- VERSAO 2801.1652
SET ver=2801.1652
color 64
cls
echo.
...
Echo.                           FACA O PROCESSO MANUALMENTE
echo.
PAUSE
GOTO menusql
 
:movedb
IF %sql% == 2012 (GOTO movesql2012) ELSE (GOTO movesql2005)
...
Set /p opcao=    Escolha uma opcao: 
Echo. ------------------------------
If %opcao% EQU 1 goto attach2005
...
Set /p opcao=    Escolha uma opcao: 
Echo. ------------------------------
If %opcao% EQU 1 goto attach2012
IF %opcao% EQU 2 goto menusql
...
:criarcloud
cls
IF EXIST "C:\SCE\AutoMagazine\Network\4.1\Support\SCECloud\integracaocloud" (GOTO criandocloud) ELSE (GOTO errocloud)
...
cls
c:\sce\integracaocloud\regasm /u AMC.IntegracaoAutoMagazine.dll /tlb /codebase

c:\sce\integracaocloud\regasm AMC.IntegracaoAutoMagazine.dll /tlb /codebase
...
COLOR 35
cls
XCOPY /Y  C:\SCE\AutoMagazine\Network\4.1\Support\SCECloud\integracaocloud C:\SCE\integracaocloud
