rem caminho do extras: C:\SCE\AutoMagazine\Network\4.1\Extras

echo off
TITLE FERRAMENTAS SUPORTE SCE --- VERSAO 2601.1357
color 64
cls
echo.
echo.    //////// 
...
IF EXIST "C:\SCE\AutoMagazine\Network\4.1\Database" (SET PC=SERVIDOR) ELSE ( SET PC=ESTACAO)
...
echo.
ECHO. 2 - Esse programa so funciona em servidores que tem a instalacao do AMG feita na raiz do Windows (c:/sce)
echo.
...
:verif
IF %PC%==SERVIDOR ( goto menuserv ) ELSE ( goto menuinest )

:menuserv
TITLE FERRAMENTAS SUPORTE SCE --- MENU PRINCIPAL DO SERVIDOR
COLOR 1f
cls
Echo. MENU DE TAREFAS - %PC% 
ECHO.
...
echo.
Echo.                         * 9. CORRIGIR QUANT EMITIDA EM CONT *
echo.
...
:processserv
IF %cpu% EQU x86 goto menuserv86
IF %cpu% NEQ x86 goto menuserv64 
...
echo.
Echo.                         * 10. CORRIGIR QUANT EMITIDA EM CONT *
echo.
...
MOVE /Y C:\SCE\AutoMagazine\Network\4.1\Support\SCEScriptEngine.dll  C:\Windows\System32
...
MOVE /Y C:\SCE\AutoMagazine\Network\4.1\Support\SCEScriptEngine.dll  C:\Windows\SysWOW64
COPY /Y C:\Windows\SysWOW64\SCEScriptEngine.dll  C:\Windows\System32
...
MOVE /Y \\%servname%\Network\4.1\Support\SCEScriptEngine.dll  C:\Windows\SysWOW64
COPY /Y C:\Windows\SysWOW64\SCEScriptEngine.dll  C:\Windows\System32
...
"\\%servname%\Network\Network\InstallClient\setup.exe"
pause
GOTO teste
...
echo.                                            :-(
echo.                        
echo.     SE O PROBLEMA EH NO SCRIPTENGINE, VOCE PODE ESCOLHER REPARAR AUTOMATICAMENTE
ECHO.
ECHO      OU IR PARA O MENU
ping localhost -n 4 >nul
...
COLOR 1f
cls
ECHO.                                    MENU DE SCRIPTS SQL
ECHO.
ECHO.                                 O QUE VOCE DESEJA FAZER?
Echo.           ==================================================================
echo.
echo.
Echo.                         * 1. COPIAR BANCOS PARA A DATABASE   * 
echo.    
echo.                         * 2. EXECUTAR SCRIPTS DO POCKETPDV   *
echo.
Echo.                         * 3. LIMPAR TABELAS LOTE/LOTEINUT    *
echo.
echo.                         * 4. CORRIGIR BANK SUSPECT           * 
echo.
Echo.                         * 5. CORRIGIR XPAG                   * 
echo.    
echo.                         * 6. TAMANHO DAS TABELAS             *
echo.
Echo.                         * 7. TAMANHO DO MDF                  * 
echo.
Echo.                         * 8. COLUNAS DO XML                  * 
echo.
echo.                         * 9. CORRIGIR SQL INSTALLNET         *
echo.    
echo.                         * 10. Sair                           *
echo. 
Echo.          ===================================================================
...
Set /p opcao=    Escolha uma opcao: 
Echo. ------------------------------
If %opcao% EQU 1 goto movedb
IF %opcao% EQU 2 goto pocketpdv
IF %opcao% EQU 3 goto limptab
If %opcao% EQU 4 goto banksuspect
If %opcao% EQU 5 goto xpag
If %opcao% EQU 6 goto tabelas
If %opcao% EQU 7 goto mdf
If %opcao% EQU 8 goto sizexml
If %opcao% EQU 9 goto runtime
If %opcao% EQU 10 goto menuserv
...
:movedb
MOVE  C:\SQLtemp\SCE\NFe_data.mdf C:\SCE\AutoMagazine\Network\4.1\Database /Y
MOVE  C:\SQLtemp\SCE\NFe_log.ldf C:\SCE\AutoMagazine\Network\4.1\Database /Y

MOVE  C:\SCE\AutoMagazine\Network\4.1\Extras\SQL\PocketPDV\PocketPDV_Data.MDF C:\SCE\AutoMagazine\Network\4.1\Database /Y
MOVE  C:\SCE\AutoMagazine\Network\4.1\Extras\SQL\PocketPDV\PocketPDV_log.LDF C:\SCE\AutoMagazine\Network\4.1\Database /Y
CLS
echo.
echo.
ECHO.                            DESEJA RODAR OS SCRIPTS DO POCKETPDV?
Echo.           ==================================================================
echo.
ECHO.                              1- SIM
ECHO.                              2- NAO
...
echo.          
ECHO.               CASO DE ALGUM ERRO, FACA O PROCESSO MANUALMENTE
echo.********************************************************************************
ping localhost -n 3 >nul
...
If %opcao% EQU 3 goto menuserv

:integracao
cls
XCOPY /Y C:\SCE\AutoMagazine\Network\4.1\Support\SCECloud\integracaocloud C:\SCE\
...
schtasks /create /tn Linker /tr "C:\SCE\AutoMagazine\Linker Filial\Linker 2000.exe" /sc daily /st 08:00 /f /ri 10 /du 99:59
goto taskfim
...
ECHO.
ECHO.
"C:\SCE\AutoMagazine\Linker Filial\Linker 2000.exe"
...
ECHO.
ECHO.
ECHO.                   GOSTARIA DE ABRIR O AGENDADOR DE TAREFAS?
ECHO.
ECHO.                                 1 - SIM
ECHO.                                 2 - NAO
echo.
...
ECHO.
ECHO.                         * 3. APP - BALANÇA TESTE 1           *
ECHO.
ECHO.                         * 4. APP - BALANÇA TESTE 2           * 
ECHO.
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\NFCeLocalDB.exe
...
CLS
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\Ajusta_NCM.exe
CLS
goto apps
...
CLS
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\Balanca_teste1.exe
goto apps
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\Balanca_teste2.exe
CLS
goto apps
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\Corrigir_referencias.exe
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\Extrair_MSI.exe
CLS
goto apps
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\RegSCE.exe
CLS
goto apps
...
C:\SCE\AutoMagazine\Network\4.1\Extras\Scripts\SerialSCE.exe
