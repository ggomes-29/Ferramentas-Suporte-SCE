rem ferramentas de auxílio ao suporte da SCe VERSAO 2022.0524 (couve-flor)
REM programa desenvolvido por Gabriel Gomes
Rem faça as modificações que quiser, mas seria muito bom que você possa compartilhar as mudanças

echo off

TITLE FERRAMENTAS SUPORTE SCE --- VERSAO 2022.0524 -- Couve-Flor
...
CLS
cls
REG ADD HKEY_LOCAL_MACHINE\SOFTWARE\SCE\SCEExec\AutoMagazine /V DisableUpdateFont /t REG_SZ /d 1 /f
cls
...
:copySEserv
XCOPY /Y /H /I C:\SCE\AutoMagazine\Network\4.1\Support\SCEScriptEngine.dll  %windir%\SysWOW64 
XCOPY /Y /H /I C:\SCE\AutoMagazine\Network\4.1\Support\SCEScriptEngine.dll  %windir%\System32
goto regSEfim

:copySEest
XCOPY /Y /H /I \\%servname%\Network\4.1\Support\SCEScriptEngine.dll  C:\SCE 
...
XCOPY /Y /H /I C:\SCE\SCEScriptEngine.dll  %windir%\SysWOW64
XCOPY /Y /H /I C:\SCE\SCEScriptEngine.dll  %windir%\System32
ping localhost -n 2  >nul
...
:fimMOV1
XCOPY /Y /H /I C:\SQLtemp\SCE\NFe_data.mdf C:\SCE\AutoMagazine\Network\4.1\Database
XCOPY /Y /H /I C:\SQLtemp\SCE\NFe_log.ldf C:\SCE\AutoMagazine\Network\4.1\Database
...
:fimMOVcloud1
cls
XCOPY /Y /H /I "C:\SCE\AutoMagazine\Network\4.1\Support\SCECloud\integracaocloud" "C:\SCE\integracaocloud"
