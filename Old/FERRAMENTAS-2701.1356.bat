...
echo off
TITLE FERRAMENTAS SUPORTE SCE --- VERSAO 2701.1356
color 64
cls
echo.
echo.    //////// 
...
IF EXIST "C:\SCE\Automagazine\Network\4.1\Database\NFe_data.mdf" (GOTO naomexe) ELSE (GOTO movedb)
...
ECHO.
ECHO.                               QUE FALTA DE ATENCAO...
ECHO.
Echo.                NADA FOI ALTERADO - FACA O PROCESSO MANUALMENTE
echo.
ECHO.
PAUSE
GOTO menusql
